 ...
 *
 */
public class WPOSUserPinDialog_Shopfl extends Window implements EventListener<Event> {

	private static final long serialVersionUID = -4853600855327838766L;

	public WPOSUserPinDialog_Shopfl() {
		super();
	}
	...
	private void showDialog(WPOS_Shopfl pos) {
		passwordField = new WPOSTextField("", null);
	...
	public static void show(WPOS_Shopfl p_POS) {
		WPOSUserPinDialog_Shopfl msg = new WPOSUserPinDialog_Shopfl();
