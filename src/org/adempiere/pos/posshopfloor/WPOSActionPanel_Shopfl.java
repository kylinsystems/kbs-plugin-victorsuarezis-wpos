...
import org.adempiere.pos.posshopfloor.search.WQueryDocType_Shopfl;
import org.adempiere.pos.posshopfloor.search.WQueryShopflHistory;
 ...
 */
public class WPOSActionPanel_Shopfl extends WPOSSubPanel_Shopfl
	 ...
	 */
	public WPOSActionPanel_Shopfl (WPOS_Shopfl posPanel) {
		super (posPanel);
	}	//	WPosSubCustomer
...
//	private	WPOSTextField 	fieldProductName;
	...
	/**	Logger			*/
	private static CLogger logger = CLogger.getCLogger(WPOSActionPanel_Shopfl.class);
	...
	public void init() {
		...
		title.setStyle("-webkit-box-sizing: content-box;\n" + 
				...
				"  background: -webkit-radial-gradient(closest-side, rgba(255,255,255,1) 0, rgba(255,0,152,1) 100%);\n" + 
				"  background: -moz-radial-gradient(closest-side, rgba(255,255,255,1) 0, rgba(255,0,152,1) 100%);\n" + 
				"  background: radial-gradient(closest-side, rgba(255,255,255,1) 0, rgba(255,0,152,1) 100%);\n" + 
...
//			lookupProduct = new WPOSLookupProduct(this, fieldProductName, new Long("1"));
			...
			lookupProduct.setStyle(WPOS_Shopfl.FONTSTYLE+WPOS_Shopfl.FONTSIZELARGE);
...
//			fieldProductName.setWidth("40%");
	...
	private void openDocType() { 
		WQueryDocType_Shopfl qt = new WQueryDocType_Shopfl(posPanel);
		qt.setVisible(true);
	...
	private void openHistory() { 
		WQueryShopflHistory qt = new WQueryShopflHistory(posPanel);
		qt.setVisible(true);
		qt.setAttribute(Window.MODE_KEY, Window.MODE_HIGHLIGHTED);
		AEnv.showWindow(qt);
...
//			fieldProductName.setText(name);
	...
	private WPOSActionPanel_Shopfl getContent(){
		return this;
	}
