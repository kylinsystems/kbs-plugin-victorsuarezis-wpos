 ...
 *
 */
public class WQueryDocType_Shopfl extends WPOSQuery_Shopfl implements POSQueryInterface {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5016700120008952274L;

	/**
	 * 	Constructor
	 */
	public WQueryDocType_Shopfl (WPOS_Shopfl posPanel)
	{
		super(posPanel);
	}	//	PosQueryProduct
	...
	protected void init()
	{
		...
		fieldName = new WPOSTextField("", null);
		...
		fieldDescription = new WPOSTextField(null, null);
