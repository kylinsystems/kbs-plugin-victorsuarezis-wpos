 ...
 *
 */
public class WPOSQuery_Shopfl extends Window
		implements POSQueryInterface, MouseListener, ListSelectionListener, EventListener<T> {

    /**
     * 
     */
    private static final long serialVersionUID = -6009207402328829273L;

    /**
     * *** Constructor ***
     * @throws HeadlessException
     */
    public WPOSQuery_Shopfl() throws HeadlessException {
        super();
    }
     ...
     *  Constructor
     */
    public WPOSQuery_Shopfl (WPOS_Shopfl posPanel)
    {
        super();
    ...
    /** POS Panel                   */
    protected WPOS_Shopfl       posPanel = null;
    /** The Table                   */
    ...
    /** Logger          */
    protected static CLogger logger = CLogger.getCLogger(WPOSQuery_Shopfl.class);
