 ...
 *
 */
public class WPOSUserPinListener_Shopfl implements EventListener<Event> {

	/**
	 * Constructor
	 * @param pos
	 */
	WPOSUserPinListener_Shopfl(WPOS_Shopfl pos) {
        this.pos = pos;
    }
    ...
    public static void setActive(boolean active){
    	WPOSUserPinListener_Shopfl.active = active;
    }
    ...
    protected void doPerformAction(Event e)
    {
        ...
        if (
           ...
           ||  //Button validation
        	...
        	WPOSUserPinDialog_Shopfl.show(pos);
