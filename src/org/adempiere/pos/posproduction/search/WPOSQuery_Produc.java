 ...
 */
public abstract class WPOSQuery_Produc extends Window implements POSQueryInterface, MouseListener, ListSelectionListener, EventListener<Event> {
	 ...
	 */
	public WPOSQuery_Produc() throws HeadlessException {
		super();
	}
	 ...
	 * 	Constructor
	 */
	public WPOSQuery_Produc (WPOS_Produc posPanel)
	{
		super();
	...
	/** POS Panel					*/
	protected WPOS_Produc		posPanel = null;
	/** The Table					*/
	...
	/**	Logger			*/
	protected static CLogger logger = CLogger.getCLogger(WPOSQuery_Produc.class);
