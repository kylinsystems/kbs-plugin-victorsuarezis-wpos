 ...
 */
public class WPOSUserPinDialog_Produc extends Window implements EventListener<Event>{
	...
	public WPOSUserPinDialog_Produc() {
		super();
	}
	...
	private void showDialog(WPOS_Produc pos) {
	...
	public static void show(WPOS_Produc p_POS) {
		WPOSUserPinDialog_Produc msg = new WPOSUserPinDialog_Produc();
