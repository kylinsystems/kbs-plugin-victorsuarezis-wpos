 ...
 */
public class WPOSUserPinListener_Produc implements EventListener<Event> {
    
	/**
	 * Constructor
	 * @param pos
	 */
	WPOSUserPinListener_Produc(WPOS_Produc pos)
    {
        this.pos = pos;
    }
    ...
    public static void setActive(boolean active){
    	WPOSUserPinListener_Produc.active = active;
    }
    ...
    protected void doPerformAction(Event e)
    {
        ...
        if (
           ...
           ||  //Button validation
        	...
        	WPOSUserPinDialog_Produc.show(pos);
