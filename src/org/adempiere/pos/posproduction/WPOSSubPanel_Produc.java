 ...
 */
public abstract class WPOSSubPanel_Produc extends Panel 
	implements EventListener<Event>
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3195844228567181621L;

	/**
	 * 	Constructor
	 *	@param posPanel POS Panel
	 */
	public WPOSSubPanel_Produc (WPOS_Produc posPanel) {
		super();
	...
	/** POS Panel						*/
	protected WPOS_Produc				posPanel;
	/** Context							*/
