 ...
 */
public class WPOSUserPinListener_Return implements EventListener<Event> {
    
	/**
	 * Constructor
	 * @param pos
	 */
	WPOSUserPinListener_Return(WPOS_Return pos)
    {
        this.pos = pos;
    }
    ...
    public static void setActive(boolean active){
        WPOSUserPinListener_Return.active = active;
    }
    ...
    protected void doPerformAction(Event e)
    {
        ...
        if (
           ...
           ||  //Button validation
        	...
        	WPOSUserPinDialog_Return.show(pos);
