...
import org.adempiere.pos.posreturn.service.CPOS_Return;
...
public class WPOS_Return extends CPOS_Return implements IFormController, EventListener, POSPanelInterface, POSScalesPanelInterface {
	...
	/** User Pin Listener 			*/
	private WPOSUserPinListener_Return 			userPinListener;
	/** Electronic Scales			*/
	...
	/** Order Panel							*/
	private WPOSActionPanel_Return 		actionPanel;
	/** Quantity panel **/
	private WPOSQuantityPanel_Return 		quantityPanel;
	/**	Info Product Panel	*/
	private WPOSInfoProduct_Return 		infoProductPanel;
	/** Current Line		*/
	private WPOSReturnLinePanel 			returnLinePanel;
	/** Function Keys		*/
	private WPOSDocumentPanel_Return 		documentPanel;
	/** Status Bar 							*/
	...
	private static final String TYPE_POS = "POR";
	...
	private boolean dynInit() { 
		setMPOS();
		userPinListener = new WPOSUserPinListener_Return(this);
		...
		quantityPanel = new WPOSQuantityPanel_Return(this);
		actionPanel = new WPOSActionPanel_Return(this);
		documentPanel = new WPOSDocumentPanel_Return(this);
		returnLinePanel = new WPOSReturnLinePanel(this, showPanelDescProduct());
		infoProductPanel = new WPOSInfoProduct_Return(this);
		East east = new East();
		...
		this.actionPanel.appendChild(returnLinePanel);
...
//		mainLayout.appendChild(southPanel);
	...
	private void setMPOS() {
		...
		listTerminal.setStyle("height:45px;"+WPOS_Return.FONTSIZEMEDIUM);
		row.setSpans("2");
...
//	}
	...
	public void addOrUpdateLine(int p_M_Product_ID, BigDecimal m_QtyOrdered) {
		...
		//	Update Info
		refreshPanel();
		returnLinePanel.seekFromProduct(p_M_Product_ID);
	}
	
	@Override
	public void changeViewPanel() {
		quantityPanel.changeViewPanel();
		returnLinePanel.changeViewPanel();
//		quantityPanel.refreshPanel();
	...
	@Override
	public void moveUp() {
		returnLinePanel.moveUp();
	}

	@Override
	public void moveDown() {
		returnLinePanel.moveDown();
	}
	...
	{
		return returnLinePanel.getM_InOutLine_ID();
	}
	
	public String getDocStatusName() {
		return MRefList.getListName(getCtx(), MInOut.DOCSTATUS_AD_Reference_ID, getReturn().getDocStatus());
	}
	...
	public boolean isUserPinValid()
	{
		...
		if (isCorrectUserPin == null)
			WPOSUserPinDialog_Return.show(this);
	...
	public void disablePOSButtons()
	{
		...
		returnLinePanel.disableTable();
	}
	
	public void restoreTable(){
		returnLinePanel.enableTable();
	}
	
	public WPOSReturnLinePanel getOrdLinePanel(){
		return returnLinePanel;
	}
	
	public WPOSActionPanel_Return getActionPanel(){
		return actionPanel;
	}
	
	public WPOSQuantityPanel_Return getQuantityPanel() {
