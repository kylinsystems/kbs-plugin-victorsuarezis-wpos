 ...
 */
public class WPOSUserPinDialog_Return extends Window implements EventListener<Event> {
    /**
	 * 
	 */
	private static final long serialVersionUID = 6703604418836828930L;

	public WPOSUserPinDialog_Return() {
		super();
	}
	...
	private void showDialog(WPOS_Return pos) {
	...
	public static void show(WPOS_Return p_POS) {
		WPOSUserPinDialog_Return msg = new WPOSUserPinDialog_Return();
