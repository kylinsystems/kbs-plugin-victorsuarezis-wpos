 ...
 */
public abstract class WPOSQuery_Return extends Window implements POSQueryInterface, MouseListener, ListSelectionListener, EventListener<Event> {
	 ...
	 */
	public WPOSQuery_Return() throws HeadlessException {
		super();
	}
	 ...
	 * 	Constructor
	 */
	public WPOSQuery_Return (WPOS_Return posPanel)
	{
		super();
	...
	/** POS Panel					*/
	protected WPOS_Return		posPanel = null;
	/** The Table					*/
	...
	/**	Logger			*/
	protected static CLogger logger = CLogger.getCLogger(WPOSQuery_Return.class);
