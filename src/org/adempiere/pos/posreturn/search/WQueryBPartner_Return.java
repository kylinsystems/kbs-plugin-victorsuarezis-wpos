 ...
 *****************************************************************************/
package org.adempiere.pos.posreturn.search;
...
import org.adempiere.pos.posreturn.grid.WPOSBPartner_Return;
 ...
 */
public class WQueryBPartner_Return extends WPOSQuery_Return {
	/**
	 * 
	 */
	 ...
	 * 	Constructor
	 */
	public WQueryBPartner_Return (WPOS_Return posPanel)
	{
		super(posPanel);
	}	//	PosQueryBPartner
	...
	/**	Logger			*/
	private static CLogger logger = CLogger.getCLogger(WQueryBPartner_Return.class);
	...
	protected void init()
	{
		...
		fieldValue = new WPOSTextField(null, null);
		...
		labelValue.setStyle(WPOS.FONTSIZESMALL);
		fieldTaxID = new WPOSTextField(null, null);
		...
		fieldContact = new WPOSTextField(null, null);
		...
		fieldPhone = new WPOSTextField(null, null);
		...
		fieldName = new WPOSTextField(null, null);
		...
		fieldName2 = new WPOSTextField(null, null);
		...
		fieldEmail = new WPOSTextField(null, null);
		...
		fieldCity = new WPOSTextField(null, null);
...
//		f_ok.setEnabled(enabled);
	...
	public String showKeyboard(Event e){
		...
		WPOSKeyboard keyboard = null;//posPanel.getKeyboard();
	...
	protected void newAction() {
		super.newAction();
		WPOSBPartner_Return t = new WPOSBPartner_Return(1, posPanel);
		AEnv.showWindow(t);
