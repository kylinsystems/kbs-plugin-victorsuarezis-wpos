 ...
 */
public class WPOSInfoProduct_Return extends WPOSSubPanel_Return {
	 ...
	 * @param posPanel
	 */
	public WPOSInfoProduct_Return(WPOS_Return posPanel) {
		super(posPanel);
...
//		row.appendChild(buttonPanel);
		...
		labelValue.setStyle(WPOS_Return.FONTSIZEMEDIUM+" font-weight:bold");
		//	Add
		...
		labelPriceName.setStyle(WPOS_Return.FONTSIZEMEDIUM+" font-weight:bold");
		//	Add
		row.appendChild(labelPriceName);
		

		labelPrice = new Label ();
		labelPrice.setStyle(WPOS_Return.FONTSIZELARGE+"font-weight:bold");
		//	Add
		row.appendChild(labelPrice);
		
		labelPriceList = new Label ();
		labelPriceList.setStyle(WPOS_Return.FONTSIZELARGE+"font-weight:bold");
		//	Add
		...
		//	For Name
		labelName = new Label ();
		labelName.setStyle(WPOS_Return.FONTSIZEMEDIUM+" font-weight:bold");
		//	Add
		...
		labelUOMSymbol.setStyle(WPOS_Return.FONTSIZEMEDIUM+" font-weight:bold");
		//	Add
		...
		labelProductCategory.setStyle(WPOS_Return.FONTSIZEMEDIUM+" font-weight:bold");
		//	Add
		...
		labelProductTax.setStyle(WPOS_Return.FONTSIZEMEDIUM+" font-weight:bold");
