 ...
 */
public class WPOSUserPinListener_Move implements EventListener<Event> {
    
	/**
	 * Constructor
	 * @param pos
	 */
	WPOSUserPinListener_Move(WPOS_Move pos)
    {
        this.pos = pos;
    }
    ...
    public static void setActive(boolean active){
        WPOSUserPinListener_Move.active = active;
    }
    ...
    protected void doPerformAction(Event e)
    {
        ...
        if (
           ...
           ||  //Button validation
        	...
        	WPOSUserPinDialog_Move.show(pos);
