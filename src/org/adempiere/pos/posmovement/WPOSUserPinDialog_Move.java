 ...
 */
public class WPOSUserPinDialog_Move extends Window implements EventListener<Event> {
    /**
	 * 
	 */
	private static final long serialVersionUID = 6703604418836828930L;

	public WPOSUserPinDialog_Move() {
		super();
	}
	...
	private void showDialog(WPOS_Move pos) {
	...
	public static void show(WPOS_Move p_POS) {
		WPOSUserPinDialog_Move msg = new WPOSUserPinDialog_Move();
