 ...
 */
public class WPOSInfoProduct_Move extends WPOSSubPanel_Move {
	 ...
	 * @param posPanel
	 */
	public WPOSInfoProduct_Move(WPOS_Move posPanel) {
		super(posPanel);
...
//		row.appendChild(buttonPanel);
		...
		labelValue.setStyle(WPOS_Move.FONTSIZEMEDIUM+" font-weight:bold");
		//	Add
		...
		//	For Name
		labelName = new Label ();
		labelName.setStyle(WPOS_Move.FONTSIZEMEDIUM+" font-weight:bold");
		//	Add
		...
		labelUOMSymbol.setStyle(WPOS_Move.FONTSIZEMEDIUM+" font-weight:bold");
		//	Add
		...
		labelProductCategory.setStyle(WPOS_Move.FONTSIZEMEDIUM+" font-weight:bold");
		//	Add
