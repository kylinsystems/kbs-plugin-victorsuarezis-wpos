...
public class WPOS_Move extends CPOS_Move implements IFormController, EventListener<Event>, POSPanelInterface, POSScalesPanelInterface {
	...
	/** User Pin Listener 			*/
	private WPOSUserPinListener_Move		userPinListener;
	/** Electronic Scales			*/
	...
	/** Order Panel							*/
	private WPOSActionPanel_Move			actionPanel;
	/** Quantity panel **/
	private WPOSQuantityPanel_Move 			quantityPanel;
	/**	Info Product Panel	*/
	private WPOSInfoProduct_Move 			infoProductPanel;
	/** Current Line		*/
	private WPOSInventoryLinePanel			inventoryLinePanel;
	/** Function Keys		*/
	private WPOSDocumentPanel_Move			documentPanel;
	/** Status Bar 							*/
...
//		settingKeyboardFocusManager();
	...
	public void init () {
		...
		try {
			...
			if(hasInventory() && actionPanel!=null){
				getMainFocus();
	...
	private boolean dynInit() { 
		setMPOS();
		userPinListener = new WPOSUserPinListener_Move(this);
		...
		actionPanel = new WPOSActionPanel_Move(this);
		documentPanel = new WPOSDocumentPanel_Move(this);
		inventoryLinePanel = new WPOSInventoryLinePanel(this);
		infoProductPanel = new WPOSInfoProduct_Move(this);
		quantityPanel = new WPOSQuantityPanel_Move(this);
		East east = new East();
		...
		this.actionPanel.appendChild(inventoryLinePanel);
	...
	private void setMPOS() {
		...
		listTerminal.setStyle("height:45px;"+WPOS_Move.FONTSIZEMEDIUM);
		row.setSpans("2");
...
//	}
	...
	public void refreshPanel() {
		//	Reload from DB
		reloadInventory();
		inventoryLinePanel.refreshPanel();
	...
	public void addOrUpdateLine(int p_M_Product_ID, BigDecimal m_QtyOrdered) {
		...
		//	Update Info
		refreshPanel();
		inventoryLinePanel.seekFromProduct(p_M_Product_ID);
	}
	
	@Override
	public void changeViewPanel() {
		quantityPanel.changeViewPanel();
		inventoryLinePanel.changeViewPanel();
//		quantityPanel.refreshPanel();
	 ...
	 * @return void
	 */
	public void newInventory(int temp) {
		newInventory();
		infoProductPanel.resetValues();
		quantityPanel.resetPanel();
		getMainFocus();
	...
	@Override
	public void moveUp() {
		inventoryLinePanel.moveUp();
	}

	@Override
	public void moveDown() {
		inventoryLinePanel.moveDown();
	}
	...
	{
		return inventoryLinePanel.getM_InventoryLine_ID();
	}
	...
	public boolean isUserPinValid()
	{
		...
		if (isCorrectUserPin == null)
			WPOSUserPinDialog_Move.show(this);
	...
	public void disablePOSButtons()
	{
		...
		inventoryLinePanel.disableTable();
	}
	
	public void restoreTable(){
		inventoryLinePanel.enableTable();
	}
	
	public WPOSInventoryLinePanel getInvLinePanel(){
		return inventoryLinePanel;
	}
