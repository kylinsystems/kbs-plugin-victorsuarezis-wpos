...
public abstract class WPOSQuery_Move extends Window implements POSQueryInterface, MouseListener, ListSelectionListener, EventListener<Event> {
	 ...
	 */
	public WPOSQuery_Move() throws HeadlessException {
		super();
	}
	 ...
	 * 	Constructor
	 */
	public WPOSQuery_Move (WPOS_Move posPanel)
	{
		super();
	...
	/** POS Panel					*/
	protected WPOS_Move			posPanel = null;
	/** The Table					*/
	...
	/**	Logger			*/
	protected static CLogger logger = CLogger.getCLogger(WPOSQuery_Move.class);
