...
public class WQueryDocType_Move extends WPOSQuery_Move implements POSQueryInterface
{
	 ...
	 * 	Constructor
	 */
	public WQueryDocType_Move (WPOS_Move posPanel)
	{
		super(posPanel);
	}	//	PosQueryProduct
