...
public class WPOS_Transfer extends CPOS_Transfer implements IFormController, EventListener<Event>, POSPanelInterface, POSScalesPanelInterface {
	...
	/** User Pin Listener 			*/
	private WPOSUserPinListener_Transfer 			userPinListener;
	/** Electronic Scales			*/
	...
	/** Order Panel							*/
	private WPOSActionPanel_Transfer 		actionPanel;
	/** Quantity panel **/
	private WPOSQuantityPanel_Transfer 		quantityPanel;
	/**	Info Product Panel	*/
	private WPOSInfoProduct_Transfer 		infoProductPanel;
	/** Current Line		*/
	private WPOSMovementLinePanel 			movementLinePanel;
	/** Function Keys		*/
	private WPOSDocumentPanel_Transfer 		documentPanel;
	/** Status Bar 							*/
	...
	private static final String TYPE_POS = "POT";
	
	/**
	 * 	Constructor - see init 
	 */
	public WPOS_Transfer() {
	...
	private boolean dynInit() { 
		setMPOS();
		userPinListener = new WPOSUserPinListener_Transfer(this);
		...
		quantityPanel = new WPOSQuantityPanel_Transfer(this);
		actionPanel = new WPOSActionPanel_Transfer(this);
		documentPanel = new WPOSDocumentPanel_Transfer(this);
		movementLinePanel = new WPOSMovementLinePanel(this, showPanelDescProduct());
		infoProductPanel = new WPOSInfoProduct_Transfer(this);
		East east = new East();
		...
		this.actionPanel.appendChild(movementLinePanel);
...
//		mainLayout.appendChild(southPanel);
	...
	private void setMPOS() {
		...
		listTerminal.setStyle("height:45px;"+WPOS_Transfer.FONTSIZEMEDIUM);
		row.setSpans("2");
...
//	}
	...
	public void refreshPanel() {
		//	Reload from DB
		reloadMovement();
		movementLinePanel.refreshPanel();
	...
	public void refreshProductInfo(MPOSKey key) {
		infoProductPanel.refreshProduct(key , getQty());
	...
	public void refreshProductInfo(int p_M_Product_ID) {
		infoProductPanel.refreshProduct(p_M_Product_ID , getQty());
	...
	public void addOrUpdateLine(int p_M_Product_ID, BigDecimal m_QtyOrdered) {
		...
		//	Update Info
		refreshPanel();
		movementLinePanel.seekFromProduct(p_M_Product_ID);
	}
	
	@Override
	public void changeViewPanel() {
		quantityPanel.changeViewPanel();
		movementLinePanel.changeViewPanel();
//		quantityPanel.refreshPanel();
	...
	@Override
	public void moveUp() {
		movementLinePanel.moveUp();
	}

	@Override
	public void moveDown() {
		movementLinePanel.moveDown();
	}
	...
	{
		return movementLinePanel.getM_MovementLine_ID();
	}
	
	public String getDocStatusName() {
		return MRefList.getListName(getCtx(), MMovement.DOCSTATUS_AD_Reference_ID, getMovement().getDocStatus());
	}
	...
	public boolean isUserPinValid()
	{
		...
		if (isCorrectUserPin == null)
			WPOSUserPinDialog_Transfer.show(this);
	...
	public void disablePOSButtons()
	{
		...
		movementLinePanel.disableTable();
	}
	
	public void restoreTable(){
		movementLinePanel.enableTable();
	}
	
	public WPOSMovementLinePanel getOrdLinePanel(){
		return movementLinePanel;
	}
	
	public WPOSActionPanel_Transfer getActionPanel(){
		return actionPanel;
	}
	
	public WPOSQuantityPanel_Transfer getQuantityPanel() {
