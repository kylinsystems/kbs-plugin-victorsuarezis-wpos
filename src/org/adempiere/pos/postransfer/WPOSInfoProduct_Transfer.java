 ...
 */
public class WPOSInfoProduct_Transfer extends WPOSSubPanel_Transfer {
	 ...
	 * @param posPanel
	 */
	public WPOSInfoProduct_Transfer(WPOS_Transfer posPanel) {
		super(posPanel);
...
//		row.appendChild(buttonPanel);
		...
		labelValue.setStyle(WPOS_Transfer.FONTSIZEMEDIUM+" font-weight:bold");
		//	Add
		...
		labelPriceName.setStyle(WPOS_Transfer.FONTSIZEMEDIUM+" font-weight:bold");
		//	Add
		row.appendChild(labelPriceName);
		

		labelPrice = new Label ();
		labelPrice.setStyle(WPOS_Transfer.FONTSIZELARGE+"font-weight:bold");
		//	Add
		row.appendChild(labelPrice);
		
		labelPriceList = new Label ();
		labelPriceList.setStyle(WPOS_Transfer.FONTSIZELARGE+"font-weight:bold");
		//	Add
		...
		//	For Name
		labelName = new Label ();
		labelName.setStyle(WPOS_Transfer.FONTSIZEMEDIUM+" font-weight:bold");
		//	Add
		...
		labelUOMSymbol.setStyle(WPOS_Transfer.FONTSIZEMEDIUM+" font-weight:bold");
		//	Add
		...
		labelProductCategory.setStyle(WPOS_Transfer.FONTSIZEMEDIUM+" font-weight:bold");
		//	Add
		...
		labelProductTax.setStyle(WPOS_Transfer.FONTSIZEMEDIUM+" font-weight:bold");
