 ...
 */
public class WQueryBPartner_Transfer extends WPOSQuery_Transfer {
	/**
	 * 
	 */
	 ...
	 * 	Constructor
	 */
	public WQueryBPartner_Transfer (WPOS_Transfer posPanel)
	{
		super(posPanel);
	}	//	PosQueryBPartner
	...
	/**	Logger			*/
	private static CLogger logger = CLogger.getCLogger(WQueryBPartner_Transfer.class);
...
//		f_ok.setEnabled(enabled);
	...
	protected void newAction() {
		super.newAction();
		WPOSBPartner_Transfer t = new WPOSBPartner_Transfer(1, posPanel);
		AEnv.showWindow(t);
...
//		}
	...
	public void refresh() {
		...
		setResults(MBPartnerInfoPOS.find (ctx,
				...
				null, fieldEmail.getText(), fieldPhone.getText(), fieldCity.getText(), true));
		unlockUI();
	}
