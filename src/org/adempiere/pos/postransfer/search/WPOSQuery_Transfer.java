 ...
 */
public abstract class WPOSQuery_Transfer extends Window implements POSQueryInterface, MouseListener, ListSelectionListener, EventListener<Event> {
	 ...
	 */
	public WPOSQuery_Transfer() throws HeadlessException {
		super();
	}
	 ...
	 * 	Constructor
	 */
	public WPOSQuery_Transfer (WPOS_Transfer posPanel)
	{
		super();
	...
	/** POS Panel					*/
	protected WPOS_Transfer		posPanel = null;
	/** The Table					*/
	...
	/**	Logger			*/
	protected static CLogger logger = CLogger.getCLogger(WPOSQuery_Transfer.class);
