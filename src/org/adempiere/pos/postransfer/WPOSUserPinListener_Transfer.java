...
import org.adempiere.pos.POSNumberBox;
 ...
 */
public class WPOSUserPinListener_Transfer implements EventListener<Event> {
    
	/**
	 * Constructor
	 * @param pos
	 */
	WPOSUserPinListener_Transfer(WPOS_Transfer pos)
    {
        this.pos = pos;
    }
    ...
    public static void setActive(boolean active){
        WPOSUserPinListener_Transfer.active = active;
    }
    ...
    protected void doPerformAction(Event e)
    {
        ...
        if (
           ...
           ||  //Button validation
        	...
        	WPOSUserPinDialog_Transfer.show(pos);
