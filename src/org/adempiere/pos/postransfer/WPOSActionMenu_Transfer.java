 ...
 */
public class WPOSActionMenu_Transfer implements  POSQueryListener, EventListener<Event>,ActionListener{

    private WPOS_Transfer pos;
    ...
    public WPOSActionMenu_Transfer(WPOS_Transfer pos)
    {
        this.pos = pos;
...
//        	tabID = DB.getSQLValue(null, "SELECT AD_Tab_ID FROM AD_Tab WHERE AD_Window_ID= ?  AND TabLevel =0",table.getAD_Window_ID());
	...
	public void actionPerformed(ActionEvent event) {
		...
		m_viewIDMap.add(new KeyNamePair(pos.getM_Movement_ID(),""));
	...
	protected ProcessInfo prepareProcess (int processId){
		 ...
		 m_pi.setRecord_ID(pos.getM_Movement_ID());
