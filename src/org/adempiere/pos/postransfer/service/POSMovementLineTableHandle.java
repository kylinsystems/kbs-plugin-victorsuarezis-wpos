 ...
 */
public class POSMovementLineTableHandle {
	 ...
	 */
	public POSMovementLineTableHandle (IMiniTable p_MovementLineTable) {
		table = p_MovementLineTable;
	}
	
	/**	Table Name			*/
	private static final String	TABLE_NAME	= "POS_MovementLine_v";
	...
	/**	Column Position		*/
	public static final int POSITION_M_MOVEMENTLINE_ID = 0;
	//public static final int	POSITION_DELETE	 		= 1;
	public static final int	POSITION_MOVEMENTQTY 	= 2;
	
	/**	Table Column Layout Info	*/
	private ColumnInfo[] columns = new ColumnInfo[] {
		new ColumnInfo(" ", "M_MovementLine_ID", IDColumn.class,false,true,null), 
		...
		new ColumnInfo(Msg.translate(Env.getCtx(), "Qty"), MOVEMENTQTY , BigDecimal.class),
		new ColumnInfo(Msg.translate(Env.getCtx(), UOM), "UOMSymbol", String.class)
	};
	
	/**	From Clause					*/
	private final String sqlFrom = "POS_MovementLine_v";
	/** Where Clause				*/
	private String sqlWhere = "M_Movement_ID=?";
	/** The Query SQL				*/
	private String sqlStatement;
	/**	Table						*/
	private IMiniTable table;
	/**	Logger						*/
	private static CLogger 	log = CLogger.getCLogger(POSMovementLineTableHandle.class);
	...
	public void setEditable(boolean isModifyPrice, boolean isDrafted) {
		...
		table.setColumnClass(POSITION_MOVEMENTQTY, BigDecimal.class, true);
