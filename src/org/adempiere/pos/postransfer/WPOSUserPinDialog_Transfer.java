...
public class WPOSUserPinDialog_Transfer extends Window implements EventListener{
	...
	public WPOSUserPinDialog_Transfer() {
		super();
	}
	...
	private void showDialog(WPOS_Transfer pos) {
	...
	public static void show(WPOS_Transfer p_POS) {
		WPOSUserPinDialog_Transfer msg = new WPOSUserPinDialog_Transfer();
