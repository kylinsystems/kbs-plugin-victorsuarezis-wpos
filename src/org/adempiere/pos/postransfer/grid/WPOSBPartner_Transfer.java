 ...
 *****************************************************************************/
package org.adempiere.pos.postransfer.grid;
...
public class WPOSBPartner_Transfer extends Window implements EventListener<Event>
{
	/**
	 * 
	 */
	 ...
	 */
	public WPOSBPartner_Transfer(int WindowNo, WPOS_Transfer pos) {
		super();
		this.pos = pos;
		m_WindowNo = WindowNo;
	...
	private static CLogger log = CLogger.getCLogger(WPOSBPartner_Transfer.class);
	...
	private WPOS_Transfer		pos = null;
