...
public abstract class WEditorPOS implements EventListener<Event>, PropertyChangeListener
{
				...
				label.addEventListener(Events.ON_CLICK, new EventListener<Event> (){
					public void onEvent(Event event) throws Exception {
						if (Events.ON_CLICK.equals(event.getName())) {
							((IZoomableEditor)WEditorPOS.this).actionZoom();
						}
    ...
    public WEditorPOS(Component comp, GridField gridField) {
     ...
     * @param gridField
     */
    public WEditorPOS(Component comp, GridField gridField, int rowIndex)
    {
        if (comp == null)
        {
	 ...
	 */
    public WEditorPOS(Component comp, String label, String description, boolean mandatory, boolean readonly, boolean updateable)
    {
    	if (comp == null)
        {
            throw new IllegalArgumentException("Component cannot be null");
	 ...
	 * @param updateable	whether the editor contents can be changed
	 */
    public WEditorPOS(Component comp, String columnName, String label, String description, boolean mandatory, boolean readonly, boolean updateable)
    {
    	if (comp == null)
        {
            throw new IllegalArgumentException("Component cannot be null");
    ...
    {
        return WEditorPOS.lISTENER_EVENTS;
    }
	...
	private static class EvaluateeWrapper implements Evaluatee {
		...
		private EvaluateeWrapper(WEditorPOS editor, GridField gridField, boolean tableEditor) {
			this.editor = editor;
			this.gridField = gridField;
